...
const ArrowChevronLeftIcon: React.FC<IconType> = memo((props) => {
  const { width = 24, height = 24, className = "", fill = "#959595" } = props;
...
ArrowChevronLeftIcon.displayName = "ArrowChevronLeftIcon";

export { ArrowChevronLeftIcon };
